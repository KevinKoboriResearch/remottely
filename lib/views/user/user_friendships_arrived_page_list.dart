...
import 'package:remottely/exceptions/check_internet_connection.dart';
  class UserFriendshipsArrivedPageList extends StatefulWidget {
  @override
  _UserFriendshipsArrivedPageListState createState() => _UserFriendshipsArrivedPageListState();
}

class _UserFriendshipsArrivedPageListState extends State<UserFriendshipsArrivedPageList> {
    @override
  void initState() {
    super.initState();
      ...
      body: Builder(
        builder: (context) {
          return StreamBuilder(
            stream: FriendshipCollection().userFriendshipsArrivedSnapshots(),
            builder: (BuildContext context,
              ...
              return LayoutCustomScrollView(
                  1,
                  UserFriendshipsArrivedPageList(),
                  'A C E I T A R',
