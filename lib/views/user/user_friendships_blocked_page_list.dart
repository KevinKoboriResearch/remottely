...
import 'package:remottely/exceptions/check_internet_connection.dart';
    class UserFriendshipsBlockedPageList extends StatefulWidget {
  @override
  _UserFriendshipsBlockedPageListState createState() => _UserFriendshipsBlockedPageListState();
}

class _UserFriendshipsBlockedPageListState extends State<UserFriendshipsBlockedPageList> {
  @override
  void initState() {
    super.initState();
      ...
      body: Builder(
        builder: (context) {
          return StreamBuilder(
            stream: FriendshipCollection().userFriendshipsBlockedSnapshots(),
            builder: (BuildContext context,
              ...
              return LayoutCustomScrollView(
                  1,
                  UserFriendshipsBlockedPageList(),
                  'B L O Q U E A D O S',
                  notificationsSnapshot,
                  UserFriendshipStreamItem('accepted', notificationsSnapshot));
            },
          );
        },
      ),
