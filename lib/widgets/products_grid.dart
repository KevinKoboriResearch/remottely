...
import 'package:remottely/widgets/product_grid_item.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return SliverGrid(
      ...
      delegate: SliverChildBuilderDelegate(
        ...
        childCount: 80,//devicesSnapshot.data.docs.length,//products.length, // widget.devicesSnapshot.data.docs.length,
      ),
    );
  }
}
